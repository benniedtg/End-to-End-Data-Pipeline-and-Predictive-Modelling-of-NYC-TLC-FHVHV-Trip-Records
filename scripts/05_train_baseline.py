"""Train Ridge baseline; evaluate on test + OOT; persist."""
...
from src.modeling import (
    ...
    build_baseline_pipeline, evaluate,
)
...
def main() -> None:
    ...
    joblib.dump(pipe, OUT_MODELS / "baseline.joblib")
    (OUT_MODELS / "metrics_baseline.json").write_text(json.dumps(metrics, indent=2))
